...
## [3.0.0](https://github.com/dmccaffery/flux-manifests/compare/v2.0.0...v3.0.0) (2026-08-28)
...
* **aws:** deploy the AWS Load Balancer Controller ([efd1486](https://github.com/dmccaffery/flux-manifests/commit/efd14860b0c2e2e77edb4cd6273a1d390a31e818))
* **aws:** elect an internal Gateway NLB via GATEWAY_NLB_SCHEME ([e7b38b4](https://github.com/dmccaffery/flux-manifests/commit/e7b38b4c27a53b96cca6a8182d13eb9e0f2804ed))
* **aws:** filter external-dns on both split-horizon zone ids ([3535b07](https://github.com/dmccaffery/flux-manifests/commit/3535b0777e1779de991bcd508a6912e4149ef004))
* **aws:** hand cilium off from terraform to flux after gateway API CRDs establish ([5a2d1d0](https://github.com/dmccaffery/flux-manifests/commit/5a2d1d01457c9d0d839256dac6a7b987df9f92ec))
...
* **aws:** serve each Route53 zone flavour with its own external-dns ([a7b804d](https://github.com/dmccaffery/flux-manifests/commit/a7b804d349650ee663af7518b70151c1a0235652))
...
* **flux-web:** admit each cloud's gateway data plane to the web UI ([697e8ae](https://github.com/dmccaffery/flux-manifests/commit/697e8ae57af326c513b3197c9551a78556fe123a))
